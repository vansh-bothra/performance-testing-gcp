...
public class ApiConfig {
    ...
    public static final String PUZZLE_ID = "1461ef6d";
    ...
    public String getSetParam() { return setParam; }
    public String getDefaultUid() { return uid; }
    public boolean isUseRandomUid() { return useRandomUid; }
    public List<String> getUidPool() { return uidPool; }
